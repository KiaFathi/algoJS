...
Output: Array of strings that were prefixed with the hashtag, but do not contain 
the hashtag.
*/
...
console.log(getHashtags("Hello #world")[0]); // "world");
console.log(getHashtags("#sorryNotSorry")[0]);// "sorryNotSorry");
...
Please return all results in the order given in the dictionary, even if they're 
not always alphabetical. The search should NOT be case sensitive, but the case 
of the word should be preserved when it's returned.
...
function autocomplete(input, dictionary){
  ...
  var choices = dictionary.filter(function(string){
...
console.log(autocomplete("ab*&1..cd", ['a']));
console.log(autocomplete('a&i', ['airplane','airport','apple','ball', 'aig']));